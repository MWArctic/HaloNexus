...
local Halo_Nexus_logo = Material("materials/halo_nexus.png", "noclamp smooth alphatest mips") 

function PANEL:createTitle()
	self.title = self:Add("DImage")
	self.title:Dock(TOP)
	self.title:DockMargin(64, 48, ScrW()-480, 0)
	--self.title:SetContentAlignment(1)

	self.title:SetSize(480, 128)	-- Size it to 150x150
	...
	--self.title:SetImage("materials/halo_nexus.png")
...
local bgggg = Material("bg_planet_reach.jpg", "noclamp smooth")
function PANEL:paintBackground(w, h)
	...
	surface.SetMaterial(bgggg)
	surface.SetDrawColor(255,255, 255, 255)
	surface.DrawTexturedRect(0, 0, w, h)
	
		surface.SetMaterial(Halo_Nexus_logo)
	surface.DrawTexturedRect(64, 48, 480, 128)
end
